...
const Hero = () => {
  ...
  return (
    <div className="bg-[#fbfbfd]">
      <div
        className="h-52 sm:h-96 carousel carousel-vertical font-SFPro "
        onClick={handleLabelClick}
      >
        <div className="carousel-item h-full ">
          <span className="text-center font-medium text-2xl sm:text-3xl py-2 mt-2 absolute text-gray w-full">
            {HomePage_Hero[0].title}
      ...
      <div className="carousel-item sm:h-96 -my-2 h-52 font-SFPro  animate-fade-up animate-once animate-duration-1000 animate-ease-in">
        ...
        <span className="text-center font-medium text-2xl sm:text-3xl py-2 mt-2 absolute text-white w-full ">
          <img
            src={HomePage_Hero[2].logoURL}
            className="sm:w-32 w-20  absolute left-[40%] lg:left-[45%]"
            alt=""
          ></img>
      ...
      <div className="lg:flex mt-4 h-full font-SFPro ">
        <div className=" m-2 ">
          <img
            src={HomePage_Hero[3].logoURL}
            alt=""
            className="absolute lg:w-1/12 lg:left-[21%] w-[100px] left-[38%] md:left-[43%]"
          />
        ...
        <div className="m-2">
          <img
            src={HomePage_Hero[4].logoURL}
            alt=""
            className="absolute lg:w-1/12 lg:left-[70%] w-[140px] left-[32%] md:left-[40%]"
          />
      ...
      <div className="lg:flex mt-4 h-full font-SFPro gap-1">
        <div className="">
          <div className="absolute lg:w-1/2 w-full">
